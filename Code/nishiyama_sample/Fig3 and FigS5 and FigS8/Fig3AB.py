...
if __name__ == "__main__":
    ...
    pred_plot(plotDataFrame=plotDataFrame_tree, colorNumdata=Life, allPat=allPat,filename="ChanpionData/Plot_tsPred_24/LOOCV_gd_PredEstData_plot_tree_0_all.png",plot_real=True, plot_est=True, plot_pred=True, plot_interval=True)
    pred_plot(plotDataFrame=plotDataFrame_tree, colorNumdata=Life, allPat=allPat,filename="ChanpionData/Plot_tsPred_24/LOOCV_gd_PredEstData_plot_tree_0_black.png",plot_real=True, plot_est=False, plot_pred=False, plot_interval=False)
    pred_plot(plotDataFrame=plotDataFrame_tree, colorNumdata=Life, allPat=allPat,filename="ChanpionData/Plot_tsPred_24/LOOCV_gd_PredEstData_plot_tree_0_Blue.png",plot_real=True, plot_est=True, plot_pred=False, plot_interval=False)
    pred_plot(plotDataFrame=plotDataFrame_tree, colorNumdata=Life, allPat=allPat,filename="ChanpionData/Plot_tsPred_24/LOOCV_gd_PredEstData_plot_tree_0_Green.png",plot_real=True, plot_est=False, plot_pred=True, plot_interval=True)
    ...
    pred_plot(plotDataFrame=plotDataFrame_tree, colorNumdata=Life, allPat=allPat,filename="ChanpionData/Plot_tsPred_24/LOOCV_gd_PredEstData_plot_tree_2_all.png",plot_real=True, plot_est=True, plot_pred=True, plot_interval=True)